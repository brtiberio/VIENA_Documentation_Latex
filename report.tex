...
\input{report_02Server} 
\clearpage

\input{report_03CodeGuides}
\clearpage
...
\phantomsection
\addcontentsline{toc}{chapter}{NovatelOEM4 GPS library Documentation}%
\includepdf[pages=-]{appendix/novatel-oem4-python}
\phantomsection
\addcontentsline{toc}{chapter}{Maxon EPOS CANopen Library Documentation}%
\includepdf[pages=-]{appendix/maxon-epos-canopen}
